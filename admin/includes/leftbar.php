...
<li><a href="#"><i class="fa fa-sitemap"></i> Bookings</a>
					<ul>
					     <li><a href="new-bookings.php">New Booking</a></li>
						<li><a href="confirmed-bookings.php">Confirmed Booking</a></li>
						<li><a href="canceled-bookings.php">Canceled Booking</a></li>
					</ul>
				</li>

		

			    <li><a href="manage-conactusquery.php"><i class="fa fa-users"></i> Manage Message</a></li>
