...
$brand=$_POST['brand'];
$seat=$_POST['seat'];
$sql = "SELECT id from tblvehicles where tblvehicles.VehiclesBrand=:brand and tblvehicles.SeatingCapacity=:seat";
...
$sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesBrand=:brand and tblvehicles.SeatingCapacity=:seat";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':seat',$seat, PDO::PARAM_STR);
$query->execute();
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          ...
          <div class="sidebar_filter">
            <form action="searchs-carresult.php" method="post">
