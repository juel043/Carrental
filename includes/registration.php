...
$sql="INSERT INTO  tblusers(FullName,EmailId,ContactNo,Password,dob,nid_no,Address,City,Country) VALUES(:fname,:email,:mobile,:password,:date,:nid,:address,:city,:country)";
            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <input type="text" class="form-control" name="nid" placeholder="NID No." required="required">
                </div>
                <div class="form-group">
