...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      ...
      <div class="col-md-8">
        <h4>What do you think about the quality of our car</h4>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">Send Feedback <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
               ...
               <?php } else { ?>
  <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Feedback</a>
